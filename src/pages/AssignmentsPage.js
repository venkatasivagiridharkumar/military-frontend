    ...
    const loadInitial = async () => {
      try {
        const [basesRes, eqRes, listRes] = await Promise.all([
          ...
          axios.get(`https://military-asset-management-system-backend-80y6.onrender.com/api/assignments`),
        ]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(
        `https://military-asset-management-system-backend-80y6.onrender.com/api/assignments`,
        form
      );
